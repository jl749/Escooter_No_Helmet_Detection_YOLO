...
while True:
    ...
    # frame_height, framewidth,_  = frame.shape
    # print(frame_height, framewidth)
    ...
    if len(boxes) > 0:
        ...
        for box in boxes:
            ...
            cv2.putText(frame, str(classIDs[i]), (x, y + 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 1)
    ...
    # draw counter
    cv2.putText(frame, 'helmet count :' + str(counter0) + ', no_helmet count: ' + str(counter1), (50, 100),
